...
export function LockedHint({
  ...
  if (variant === "subtle") {
    return (
      <div className="flex items-start gap-2 rounded-md border border-milsaca-dourado/40 bg-milsaca-dourado/10 px-3 py-2 text-xs text-milsaca-cafezal">
      ...
      <div className="relative grid gap-4 sm:grid-cols-[1fr_auto] sm:items-center">
        <div className="space-y-1.5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-[0.16em] text-milsaca-cafezal">
              Recurso do plano Pro
            </span>
          </div>
          <h3 className="text-base font-semibold text-milsaca-verde">
            {label}
          </h3>
        ...
        <Link
          href="/painel/corretora/assinatura"
          className="inline-flex h-10 shrink-0 items-center justify-center gap-1.5 rounded-md bg-milsaca-dourado px-4 text-sm font-semibold text-milsaca-preto shadow-[inset_0_1px_0_rgba(255,255,255,0.25),0_6px_18px_-8px_rgba(201,169,97,0.5)] transition-all hover:brightness-105"
        >
          Liberar agora
