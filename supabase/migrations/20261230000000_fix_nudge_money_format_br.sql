-- =================================================================
-- Milsaca — Fix: formatação BR de dinheiro nos nudges (proposta/pagamento)
-- Data: 2026-06-13 (timestamp único — ver docs/milsaca/convencao-migrations.md)
-- =================================================================
-- 20261220 formatava preço/valor com replace(to_char(v,'FM..D00'),'.',',').
-- No lc_numeric do banco (G=',' D='.'), to_char(1700)='1,700.00'; o replace
-- trocava só o decimal → '1,700,00' (vírgula dupla, errado). O correto em
-- BR ('1.700,00') troca AMBOS os separadores: translate(s, '.,', ',.').
-- Recria as 2 funções só com essa correção. create or replace, idempotente.
-- =================================================================
